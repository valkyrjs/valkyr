...
import z, { type ZodDiscriminatedUnion, type ZodObject, type ZodUnion } from "zod";
...
export const validators = {
  data: new Map<Event["type"], ZodObject | ZodUnion | ZodDiscriminatedUnion>([
  ...
  meta: new Map<Event["type"], ZodObject | ZodUnion | ZodDiscriminatedUnion>([
